...
var stateString = "0\n" + // protocol version
	...
	"0x600027791f\n" + // level get: PREAMP|ATT|VOX|AF|RF|NR|CWPITCH|RFPOWER|MICGAIN|KEYSPD|COMP|AGC|BKINDL|VOXGAIN|MONITOR_GAIN|NB (TODO: use metering protocol to add SWR|ALC|RFPOWER_METER|COMP_METER)
	"0x600027791f\n" + // level set: PREAMP|ATT|VOX|AF|RF|NR|CWPITCH|RFPOWER|MICGAIN|KEYSPD|COMP|AGC|BKINDL|VOXGAIN|MONITOR_GAIN|NB
	"0\n" + // parm get: none
	"0\n" // parm set: none
